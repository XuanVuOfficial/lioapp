    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <img src="https://thienlong.pro.vn/khachhang/icon.jpg" alt="HKTT Icon" className="w-16 h-16 rounded-2xl mx-auto mb-6 object-cover shadow-lg shadow-emerald-100" />
